...
YOU CAN DO THIS IN A MORE AUTOMATED WAY (IMAGINE YOU HAD 40,000 ROWS OF DATA - IT WOULD BE IMPOSSIBLE TO LOOK THROUGH TO SEE WHERE THE PROBLEMS ARE) USING THE `which()` FUNCTION TO FIND THE PROBLEMATIC ROWS AS FOLLOWS (I JUST DEMONSTRATED FOR NORWAY MAPLE):

```{r}
fixNorway<-which(Leaves$Species == "Norway Maple"| Leaves$Species == "Norway mapel") #identifies the row numbers that meet a condition
Leaves$Species[fixNorway]<-"Norway maple" #uses indexing to find the rows
